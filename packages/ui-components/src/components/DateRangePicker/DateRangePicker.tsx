      ...
      <div className={styles.calendarGrid}>
        ...
        <div className={styles.monthNav}>
          <button
            ...
            aria-label={t.dateRangePicker.prevYears}
            className={cn(
              styles.navButton,
              canGoPrevYears ? styles.navButtonEnabled : styles.navButtonDisabled
            )}
          >
          ...
          <span className={styles.monthHeading}>
            {t.dateRangePicker.yearRange(yearRangeStart, yearRangeStart + 11)}
          </span>
          ...
          <button
            ...
            aria-label={t.dateRangePicker.nextYears}
            className={cn(
              styles.navButton,
              canGoNextYears ? styles.navButtonEnabled : styles.navButtonDisabled
            )}
          >
            <svg viewBox="0 0 16 16" fill="currentColor" className={styles.iconSm} aria-hidden="true">
              <path
        ...
        <div
          ...
          role="grid"
          tabIndex={-1}
          aria-label={t.dateRangePicker.selectYear}
